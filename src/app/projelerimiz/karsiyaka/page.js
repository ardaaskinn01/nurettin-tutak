...
export default function Karaburun() {
  ...
  const projects = [
    { title: "Karşıyaka", link: "/projelerimiz/karsiyaka/bina", villas: 25 },
  ];
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-44 pb-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-light text-white mb-4">KARŞIYAKA / İZMİR</h2>
          <div className="w-24 h-0.5 bg-gradient-to-r from-blue-400 to-blue-600 mx-auto"></div>
          <p className="mt-6 text-gray-300 max-w-2xl mx-auto">
            İşlek caddede lüks daire ve dükkanlar
          </p>
        </div>
              ...
              >
                <div className="text-center px-6 py-4">
                  ...
                  <div className="mt-2 text-blue-300 text-lg font-light">
                    {project.villas} Daire 12 Dükkan
                  </div>
