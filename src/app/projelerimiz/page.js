          ...
          <div className="flex flex-col items-center gap-12">
            {projects.map((project, index) => (
              <Link
                href={project.link}
                key={index}
                className="group relative overflow-hidden rounded-lg border-l-4 border-orange-500 w-full max-w-2xl h-36 bg-white bg-opacity-90 transition-transform duration-300 hover:scale-160 shadow-xl"
              >
