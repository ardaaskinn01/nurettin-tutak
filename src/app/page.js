      ...
      <div className="bg-gray-900 text-white min-h-screen flex flex-col">
        ...
        <section className="relative pt-32 md:pt-40 h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="z-10 relative text-center px-6 max-w-5xl mx-auto">
            <div className="mb-8">
              <div className="w-24 h-24 md:w-32 md:h-32 mx-auto rounded-full border-4 border-green-400/50 overflow-hidden shadow-xl">
                <Image
                  src="/background.jpg"
                  alt="Nurettin Tutak"
                  width={128}
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Merhaba, Ben <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-green-400">Nurettin</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/cv.pdf"
                download
                className="px-8 py-4 bg-gradient-to-r from-orange-500 to-green-500 text-white rounded-lg hover:from-orange-600 hover:to-green-600 transition-all duration-500 shadow-lg font-medium flex items-center justify-center gap-2"
              >
              ...
              <Link 
                href="/iletisim" 
                className="px-8 py-4 bg-transparent border-2 border-orange-400 text-orange-400 rounded-lg hover:bg-orange-400 hover:text-gray-900 transition-all duration-300 font-medium flex items-center justify-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="w-12 h-12 bg-green-400/20 backdrop-blur-md rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110 border border-green-400/30">
              <svg
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                <div className="bg-gray-700/50 p-8 rounded-xl shadow-lg border border-gray-600/30">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <a href="mailto:nurettintutak@gmail.com" className="text-gray-300 hover:text-orange-400 transition-colors text-lg">
                ...
                <div className="bg-gray-700/50 p-8 rounded-xl shadow-lg border border-gray-600/30">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <a href="tel:+905555555555" className="text-gray-300 hover:text-green-400 transition-colors text-lg">
                      +90 555 555 55 55
                    </a>
                  </div>
                </div>
