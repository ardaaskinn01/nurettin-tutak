...
export default function Ocakli() {
  ...
  const images = Array.from({ length: 15 }, (_, i) => `/misafirhane/(${i + 1}).jpeg`);
      ...
      <main className="pt-40 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-blue-400 tracking-widest uppercase">Yıkama / Kereste İmalatı</span>
            <h1 className="mt-4 text-3xl md:text-4xl font-bold text-white">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">
                Ulucak / İzmir
              </span>
              <br />
              <span className="text-white">Yıkama ve Kereste İşleme Tesisimiz</span>
            </h1>
            <div className="mt-6 h-1 w-24 bg-gradient-to-r from-blue-500 to-blue-700 mx-auto rounded-full" />
            <p className="mt-6 text-gray-300 max-w-3xl mx-auto">
              Modern tesisimizde çevreye duyarlı, sürdürülebilir yıkama ve kereste işleme süreçleri yürütülmektedir.
            </p>
          </div>
          ...
          >
            ...
            <div className="relative max-w-6xl w-full h-[90vh]">
              <div className="relative w-full h-full">
                <Image
                  src={selectedImage}
                  alt={`Kereste Görseli ${currentIndex + 1}`}
                  fill
