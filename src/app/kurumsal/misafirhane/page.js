...
export default function Misafirhane() {
  ...
  const images = Array.from({ length: 5 }, (_, i) => `/imalat/(${i + 1}).jpeg`);
      ...
      <main className="pt-40 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-blue-400 tracking-widest">KONAKLAMA ALANIMIZ</span>
            <h1 className="mt-4 text-3xl md:text-4xl font-bold text-white">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">
                Yönetim Kurulu
              </span>
              <br />
              <span className="text-white">Misafirhanesi</span>
            </h1>
            <div className="mt-6 h-1 w-24 bg-gradient-to-r from-blue-500 to-blue-700 mx-auto rounded-full" />
            <p className="mt-6 text-gray-300 max-w-3xl mx-auto">
              Kurumsal konuklarımız için hazırlanmış olan modern misafirhanemiz, huzurlu bir konaklama deneyimi sunar.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {images.map((src, index) => (
              ...
              >
                <Image
                  src={src}
                  alt={`Misafirhane Görsel ${index + 1}`}
                  fill
        ...
        >
          ...
          >
            ...
            <div className="relative w-full h-[90vh]">
              <Image
                src={selectedImage}
                alt={`Misafirhane Görsel ${currentIndex + 1}`}
                fill
